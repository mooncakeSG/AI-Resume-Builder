  ...
  return (
    <div className="p-8 max-w-4xl mx-auto bg-white shadow-lg">
      <header className="mb-8 text-center">
        ...
        {professionalLinks && (
          <div className="mt-4 flex justify-center items-center gap-4 flex-wrap text-gray-600">
            {professionalLinks.linkedin && (
              <a href={professionalLinks.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-600">
            ...
            {professionalLinks.github && (
              <a href={professionalLinks.github} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-gray-900">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            {professionalLinks.portfolio && (
              <a href={professionalLinks.portfolio} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-purple-600">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            {professionalLinks.website && (
              <a href={professionalLinks.website} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-green-600">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            {professionalLinks.twitter && (
              <a href={professionalLinks.twitter} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-400">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            {professionalLinks.other && (
              <a href={professionalLinks.other} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-gray-800">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M14.851 11.923c-.179-.641-.521-1.246-1.025-1.749-1.562-1.562-4.095-1.563-5.657 0l-4.998 4.998c-1.562 1.563-1.563 4.095 0 5.657 1.562 1.563 4.096 1.561 5.656 0l3.842-3.841.333.009c.404 0 .802-.04 1.189-.117l-4.657 4.656c-.975.976-2.255 1.464-3.535 1.464-1.28 0-2.56-.488-3.535-1.464-1.952-1.951-1.952-5.12 0-7.071l4.998-4.998c.975-.976 2.256-1.464 3.536-1.464 1.279 0 2.56.488 3.535 1.464.493.493.861 1.063 1.063 1.672l-.787.784zm-5.703.147c.178.643.521 1.25 1.026 1.562 1.562 1.563 4.096 1.561 5.656 0l4.999-4.998c1.563-1.562 1.563-4.095 0-5.657-1.562-1.562-4.095-1.563-5.657 0l-3.841 3.841-.333-.009c-.404 0-.802.04-1.189.117l4.656-4.656c.975-.976 2.256-1.464 3.536-1.464 1.279 0 2.56.488 3.535 1.464 1.951 1.951 1.951 5.119 0 7.071l-4.999 4.998c-.975.976-2.255 1.464-3.535 1.464-1.28 0-2.56-.488-3.535-1.464-.494-.495-.863-1.067-1.107-1.678l.788-.785z"/>
                </svg>
                Other
              </a>
            )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {languages.map((lang, index) => (
              <div key={index} className="bg-gray-50 p-4 rounded-lg">
                ...
                {lang.certification && (
                  <p className="text-gray-600 text-sm mt-2">{lang.certification}</p>
                )}
              </div>
            ))}
          </div>
