...
const CreativeTemplate = ({ data }) => {
  const { certifications, languages, projects, skills, personal, experience, education, professionalLinks } = data || {};
    ...
    <div className="p-8 max-w-4xl mx-auto bg-gradient-to-br from-purple-50 to-blue-50">
      <header className="mb-10 relative">
        ...
        <div className="flex flex-wrap gap-4 text-gray-600">
          {personal?.email && (
            <a href={`mailto:${personal.email}`} className="flex items-center hover:text-purple-600 transition-colors">
        ...
        {professionalLinks && (
          <div className="mt-4 flex flex-wrap gap-4 text-gray-600">
            {professionalLinks.linkedin && (
              <a href={professionalLinks.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-600 transition-colors">
            ...
            {professionalLinks.github && (
              <a href={professionalLinks.github} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-gray-900 transition-colors">
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            {professionalLinks.portfolio && (
              <a href={professionalLinks.portfolio} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-purple-600 transition-colors">
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            {professionalLinks.website && (
              <a href={professionalLinks.website} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-green-600 transition-colors">
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            {professionalLinks.twitter && (
              <a href={professionalLinks.twitter} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-blue-400 transition-colors">
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            {professionalLinks.other && (
              <a href={professionalLinks.other} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-gray-800 transition-colors">
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
